...
const ServiceBox = ({ name, description, imgUrl, link, buttonText }: 
    ...
    return (
        <li className="h-[500px] flex flex-col items-start flex-1 shadow-xl p-10 bg-slate-100 max-w-xs min-w-[280px] rounded-2xl">
            ...
            <Link className="mt-auto px-4 py-3 rounded-xl bg-blue-600 text-white font-semibold" href={`/services/ai-service/${link}`}>{buttonText}</Link>
        </li>
    );
}
