...
const RemoveBgPage = async ({ params }: {params: {lang: "en" | "en-US" | "fr" | "fr-FR"}}) => {
    ...
    return (
        <section className="relative px-10 py-32 flex flex-col items-center min-h-screen w-full gap-20 bg-gray-100">
            ...
            <nav className="nav__padding z-50 flex text-sm text-gray-700 items-center gap-4 flex-row">
                ...
                <p className="text-lg sm:text-3xl font-black text-black">Remove<span className='text-blue-600'>.Bg</span></p>
